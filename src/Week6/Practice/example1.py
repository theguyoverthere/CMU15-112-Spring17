...
def init(data):
    data.mouseText = "No Mouse Presses yet"
    data.keyText = "No Key Presses yet"
...
def keyPressed(event, data):
    data.keyText = ("last keyPressed : char=" + event.char + ", keysym=" +
                   event.keysym)
...
def redrawAll(canvas, data):
    canvas.create_text(data.width / 2, 20, text="My Example 1")
